...
from.views import AboutPageView, CheckoutPageView, ContactPageView, HomePageView,  LoginPageView,LogoutPageView, PasswordChangePageView, CatalogPageView, CheckoutPageView
